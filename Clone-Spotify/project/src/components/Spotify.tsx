...
import { Play, Pause, Volume2, Heart, Repeat, Shuffle, Home, Search, Library, Plus, SkipBack, SkipForward, Clock, ArrowLeft, Menu, X, Github } from 'lucide-react';
...
const Spotify = () => {
  ...
  return (
    <div className="h-screen bg-black text-white flex flex-col">
      {/* Header */}
      <div className="fixed top-0 left-0 right-0 bg-black/90 z-50 p-4 flex justify-between items-center">
        <Link
          to="/"
        ...
        <a
          href="https://github.com/yourusername/spotify-clone"
          target="_blank"
      ...
      <div className="flex flex-1 mt-16">
        {/* Sidebar */}
        <div className={`${
          isSidebarOpen ? 'fixed inset-0 z-40 bg-black' : 'hidden'
        } md:relative md:block w-64 bg-black flex-shrink-0`}>
        ...
        {/* Main Content */}
        <div className="flex-1 bg-gradient-to-b from-[#1e1e1e] to-[#121212] overflow-y-auto h-[calc(100vh-90px)] w-full">
          <div className="p-4 md:p-6">
            {/* Featured Playlists */}
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold mb-4">Good evening</h2>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-bold text-white group-hover:underline truncate">{playlist.name}</h3>
                        <p className="text-sm text-gray-400 truncate">{playlist.type}</p>
                      </div>
                    </div>
            ...
            {/* Popular Songs */}
            <div className="mt-8">
              <h2 className="text-xl md:text-2xl font-bold mb-4">Popular Songs</h2>
              {/* Table Header - Hidden on mobile */}
              <div className="hidden md:grid grid-cols-[16px,4fr,2fr,1fr] gap-4 px-4 py-2 text-gray-400 border-b border-gray-800 sticky top-0 bg-[#121212] z-10">
                <span>#</span>
                <span>Title</span>
                <span>Album</span>
              ...
              <div className="mt-4">
                {songs.map((song, index) => (
                  <div
                    ...
                    className={`group grid grid-cols-[1fr] md:grid-cols-[16px,4fr,2fr,1fr] gap-4 px-4 py-2 rounded-md hover:bg-[#2a2a2a] cursor-pointer ${
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#181818] border-t border-[#282828] px-4 h-[90px]">
        <div className="flex items-center justify-between h-full">
          {/* Current Song Info */}
          <div className="flex items-center gap-4 min-w-[120px] md:min-w-[180px] w-[30%]">
            {currentSong && (
              <>
                <img
